...
class RetirementApp {
    ...
    updateBirthDate(id, dateOfBirth) {
        if (dateOfBirth) {
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" value="${birthDate}" 
                                        onchange="app.updateBirthDate(${m.id}, this.value)" 
                                        class="w-full px-3 py-2 border rounded">
        ...
        return `
            <div>
                ...
                <div class="bg-white border-2 border-blue-200 rounded-lg p-6 mb-8">
                    ...
                    ` : `
                        <p class="text-gray-500 text-center py-4">Add salary information in the Family tab to see Social Security projections</p>
                    `}
                </div>
